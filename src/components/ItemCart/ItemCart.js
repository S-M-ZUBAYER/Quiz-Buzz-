...
const ItemCart = ({ topic }) => {
    const { name, logo, total } = topic;

    return (

        <div className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-96 bg-slate-600" style={{ backgroundImage: `url(${logo})` }}>
