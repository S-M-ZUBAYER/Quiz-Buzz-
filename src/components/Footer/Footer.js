...
const Footer = () => {
    return (
        <footer className="px-4 lg:mt-28 sm:mt-10 divide-y dark:dark:bg-gray-800 dark:dark:text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a href="./" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center lg:text-2xl lg:xl font-semibold">Quiz Buzz</span>
                    </a>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:dark:text-gray-400">© 2022 Company Co. All rights reserved.</div>
        </footer>
    );
};
